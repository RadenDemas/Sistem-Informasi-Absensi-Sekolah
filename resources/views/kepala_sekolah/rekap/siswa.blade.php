    ...
    <div class="container">
        ...
        <form method="GET" class="row mb-4">
            ...
            <div class="col-md-2 text-end">
                <a href="{{ route('kepala.sekolah.rekap.data.guru.download', ['bulan' => $bulan, 'tahun' => $tahun, 'search' => $search]) }}" class="btn btn-hijau-sias" style="width:fit-content;">Download</a>
            </div>
        </form>
