...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('kepala.sekolah.dashboard') }}" class="btn btn-hijau-sias">
    ...
    <div class="row g-4">
        @forelse ($subKelasList as $kelasItem)
            <div class="col-md-4 col-lg-3">
                <a href="{{ route('kepala.sekolah.kelas.tanggal', ['kelas_id' => $kelasItem->kelas_id, 'tanggal' => now()->toDateString()]) }}" class="text-decoration-none">
